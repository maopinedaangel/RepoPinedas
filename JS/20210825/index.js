...
// Escribir una función que reciba el valor de una compra y el medio de pago. Si el valor de la compra es superior a 100.000 y se paga en efectivo, se debe aplicar un descuento de 30%; si la compra es superior a 100.000 y el pago es con tarjeta, se debe aplicar un descuento del 20%. Si la compra es inferior a 100.000, se debe aplicar un descuento del 10%, independiente del valor de la compra. La función debe retornar el valor final a pagar.
